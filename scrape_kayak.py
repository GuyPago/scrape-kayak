...
# 'RIO', 'MIA','MOW', 'JMK', 'YTO', 'MAL','PRG','LAS', 'MSQ', 'CAI', 'SAN', 'SIN','DEN', 'AMS', 'CPH','VCE','MLA','CND',
# 'LIR', 'DUB','BUD', 'SJO','ADD', 'CMN', 'AMM', 'KEF', 'SEZ', 'OTP','MAN','WAS','MLE', 'ORL','SJU','DAL','FRA','DCA',
# 'JFK', 'AMM',CEZ, 'TGD', 'BER', 'EWR', 'PVG', 'LHR', 'LTN','OSL','MNL','PTY','AKL', 'LED','SCL', 'ALA','TAS','LWO',
# 'KUL', 'HRE', 'UIO', 'EDI', 'SBZ', 'ODS', 'KTM','CEZ','CUN', 'NAS', 'AYT', 'ADB','MUC','JNB', 'ORD', 'JTR', 'YYZ',
# 'BRU', 'MAL','GLA', 'ABZ','HNL', 'KIV', 'SOF', 'SJJ', 'MSQ','MUC','CUN', 'NUE', 'BUD', 'VCE', 'AUH', 'CEZ', 'AER'
destinations = []
